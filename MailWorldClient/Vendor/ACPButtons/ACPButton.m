...
- (void) setStyleType:(ACPButtonType)style {
    ...
    switch (style) {
        ...
        case ACPButtonPurple:
            ...
            break;
        case ACPButtonWhite:
            _topColor = [UIColor colorWithRed:0.956863 green:0.956863 blue:0.956863 alpha:1];
            _bottomColor = [UIColor colorWithRed:0.992157 green:0.992157 blue:0.992157 alpha:1];
            _borderColor = [UIColor colorWithRed:0.882353 green:0.882353 blue:0.882353 alpha:1];
            _inneColor = nil;
            break;
        case ACPButtonOrange:
            _topColor = [UIColor colorWithRed:1.000000 green:0.580392 blue:0.305882 alpha:1];
            _bottomColor = [UIColor colorWithRed:1.000000 green:0.580392 blue:0.305882 alpha:0.7];
            _borderColor = [UIColor colorWithRed:1.000000 green:0.580392 blue:0.305882 alpha:0.5];
            _inneColor = nil;
            break;
        default:
            break;
